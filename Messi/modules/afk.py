...
from Messi.modules.disable import DisableAbleCommandHandler, DisableAbleMessageHandler
from Messi.modules.redis.afk_redis import start_afk, end_afk, is_user_afk, afk_reaso
from Messi.modules.users import get_user_id

from Messi.modules.helper_funcs.alternate import send_message
from Messi.modules.helper_funcs.readable_time import get_readable_time
...
def afk(update, context):
    ...
    try:
        update.effective_message.reply_video(
            AFKVID,caption="{}𝓢𝓮𝓮 𝔂𝓸𝓾 𝓲𝓷 𝓽𝓱𝓮 𝓱𝓪𝓵𝓵 𝓸𝓯 𝓯𝓪𝓶𝓮!⚽️".format(fname))
    except BadRequest:
        pass
