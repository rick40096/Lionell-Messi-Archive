...
def get_user_list(__init__, key):
    with open("{}/Messi/{}".format(os.getcwd(), __init__), "r") as json_file:
        return json.load(json_file)[key]

# enable logging
FORMAT = "[Messi] %(message)s"
logging.basicConfig(
...
LOGGER.info("Project maintained by: github.com/ricks40096 (t.me/ricks_005)")
...
if ENV:
    ...
    EVENT_LOGS = os.environ.get("EVENT_LOGS", "-1001555358542")
    ...
    MONGO_DB = os.environ.get("MONGO_DB", "Messi")
    ...
    from Messi.config import Development as Config
...
DRAGONS.add(5708151910)
DEV_USERS.add(OWNER_ID)
DEV_USERS.add(2078455329)
...
from Messi.modules.helper_funcs.handlers import (
